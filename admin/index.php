                        ...
                        <div class="is-form">
                            <div class="hero-body">
                                ...
                                if(isset($_POST["login"])){
                                    ...
                                    try{
                                        $admin_login_query = $connect->prepare("SELECT * FROM admin WHERE username=? AND password=?");
                                        $admin_login_query->execute([$username,md5($password)]);
                                        $count_admins = $admin_login_query->rowCount();
                                        if($count_admins == 1){
                                            //Logged In
                                ...
                                ?>
                                    <div class="control has-validation">
                                        ...
                                        <input type="text" class="input" placeholder="Enter your username" required name="username">
                                    ...
                                    <div class="button-wrap has-help"> 
                                        <button type="submit" class="button h-button is-big is-rounded is-primary is-bold is-raised" name="login">Login Now</button>
                                ...
                                <form id="recover-form" class="login-wrapper is-hidden" method="POST">
                                    <p class="recover-text">
                                        Enter your username and click on the confirm button, We'll send you a text message detailing the steps to complete the procedure
                                    </p>
                                    <div class="control has-validation">
                                        <input type="text" class="input" name="rec_reg" required placeholder="Enter your username">
                                        <small class="error-text">This is a required field</small>
                                        <div class="auth-label">Username</div>
                                        <div class="auth-icon">
                                            <i class="lnil lnil-user"></i>
